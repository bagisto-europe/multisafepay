@component('shop::emails.layout')
    <div style="margin-bottom: 34px;">
        ...
        <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;">
            @lang('multisafepay::app.emails.orders.created.payment')<br />
            <a href="{{ route('shop.customer.order.pay', $order->id) }}">@lang('multisafepay::app.emails.orders.created.complete-payment')</a><br />
            @lang('multisafepay::app.emails.orders.created.already-paid')
        </p>
    </div>

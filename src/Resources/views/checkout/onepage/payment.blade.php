                        ...
                        <x-slot:content class="!p-0 mt-8">
                            <div class="flex flex-wrap gap-7">
                                ...
                                >
                                    ...
                                    <div v-if="payment.method === 'multisafepay'" class="multisafepay-container">
                                        <div v-for="paymentMethod in MultiSafePaymentMethods" class="multisafepay-method">
                                            <input 
                                                type="radio" 
                                                name="payment[method]" 
